# JointCoder 千医 ICD 智能编码系统

本项目面向住院病历的疾病与手术 ICD 辅助编码。疾病编码主链路已改造为
**LangChain + LangGraph 多智能体工作流**，在复用现有微调 Qwen3 模型服务的
基础上，加入条件路由、短期记忆和经过人工审核的长期记忆。

> 系统输出用于编码员辅助审核，不替代临床诊断或最终人工编码决策。
