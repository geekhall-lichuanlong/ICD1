...
tmux new-session -d -s sagent1 "bash --login -c 'conda activate qianfoshan; RAY_memory_monitor_refresh_ms=0 CUDA_VISIBLE_DEVICES=1 swift deploy --model_type qwen3 --tensor_parallel_size 2 --model /mnt/bigdisk/all_surgery/model/agent1/v3-20251115-123708/checkpoint-20955 --response_prefix \"<think>\n\n</think>\n\n\" --repetition_penalty=1.05 --port 8000; exec bash'"

tmux new-session -d -s sagent2 "bash --login -c 'conda activate qianfoshan; RAY_memory_monitor_refresh_ms=1 CUDA_VISIBLE_DEVICES=1 swift deploy --model_type qwen3 --tensor_parallel_size 2 --model /mnt/bigdisk/all_surgery/model/agent2/v0-20251116-135412/checkpoint-4790 --response_prefix \"<think>\n\n</think>\n\n\" --repetition_penalty=1.05 --port 8001; exec bash'"
...
tmux new-session -d -s sagent4 "bash --login -c 'conda activate qianfoshan; RAY_memory_monitor_refresh_ms=1 CUDA_VISIBLE_DEVICES=2 swift deploy --model_type qwen3 --tensor_parallel_size 2 --model /mnt/bigdisk/all_surgery/model/agent4/v0-20251117-084848/checkpoint-9414 --response_prefix \"<think>\n\n</think>\n\n\" --repetition_penalty=1 --port 8003; exec bash'"

tmux new-session -d -s sagent5 "bash --login -c 'conda activate qianfoshan; RAY_memory_monitor_refresh_ms=1 CUDA_VISIBLE_DEVICES=2 swift deploy --model_type qwen3 --tensor_parallel_size 2 --model /mnt/bigdisk/all_surgery/model/agent5/v0-20251125-095043/checkpoint-8712 --response_prefix \"<think>\n\n</think>\n\n\" --repetition_penalty=1 --port 8009; exec bash'"

echo "Created tmux sessions: sagent1 to sagent5, all activating conda environment 'qianfoshan' and starting corresponding swift deploy commands."
